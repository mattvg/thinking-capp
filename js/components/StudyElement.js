...
class StudyElement extends React.Component {
	constructor(props) {
		super(props)
	...
	render() {
		...
		if (element == undefined) {
			...
			var desc = element['desc'][language]['text']
...
export default connect(state => ({ config: state.config, elements: state.elements }))(StudyElement)
